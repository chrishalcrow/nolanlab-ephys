...
for session in sessions:
    stageout_dict[deriv_folder / f"M{mouse:02d}/D{day:02d}/{session}/sub-{mouse:02d}_day-{day:02d}_ses-{session}_srt-{protocol}_analyzer"] = eddie_active_projects / "Wolf/MMNAV/derivatives" / f"M{mouse:02d}/D{day:02d}/{session}/"
